...
const AIChatbot = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', content: 'Hi! 👋 I\'m your HealthCare HMS assistant. How can I help you today? I can answer questions about our features, pricing, or help you get started.' }
  ]);
